...
/**
 * Represents an blocklymoodle question.
 *
...
class qtype_blocklymoodle_question extends question_with_responses {
     ...
     * @return qtype_blocklymoodle_format_renderer_base the response-format-specific renderer.
     */
    public function get_format_renderer(moodle_page $page) {
        return $page->get_renderer('qtype_blocklymoodle', 'format_' . $this->responseformat);
    }
    ...
    public function check_file_access($qa, $options, $component, $filearea, $args, $forcedownload) {
        ...
        } else if ($component == 'qtype_blocklymoodle' && $filearea == 'graderinfo') {
