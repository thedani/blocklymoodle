...
/**
 * Blocklymoodle question renderer class.
 *
 * @package    qtype
...
/**
 * Generates the output for blocklymoodle questions.
 *
 * @copyright  2009 The Open University
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_blocklymoodle_renderer extends qtype_renderer {
...
//        if($qa->get_current_manual_mark() == 0){
    ...
    public function manual_comment(question_attempt $qa, question_display_options $options) {
        ...
        return html_writer::nonempty_tag('div', $question->format_text(
                $question->graderinfo, $question->graderinfo, $qa, 'qtype_blocklymoodle',
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
abstract class qtype_blocklymoodle_format_renderer_base extends plugin_renderer_base {
    /**
...
/**
 * An blocklymoodle format renderer for blocklymoodles where the student should not enter
 * any inline response.
 *
 * @copyright  2013 Binghamton University
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_blocklymoodle_format_noinline_renderer extends plugin_renderer_base {

    protected function class_name() {
        return 'qtype_blocklymoodle_noinline';
    }
...
/**
 * An blocklymoodle format renderer for blocklymoodles where the student should use the HTML
 * editor without the file picker.
 *
 * @copyright  2011 The Open University
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_blocklymoodle_format_editor_renderer extends plugin_renderer_base {
    protected function class_name() {
        return 'qtype_blocklymoodle_editor';
    }

    public function response_area_read_only($name, $qa, $step, $lines, $context) {
        return html_writer::tag('div', $this->prepare_response($name, $qa, $step, $context),
                array('class' => $this->class_name() . ' qtype_blocklymoodle_response readonly'));
    }
    ...
    public function response_area_input($name, $qa, $step, $lines, $context) {
        ...
        $output .= html_writer::start_tag('div', array('class' =>
                $this->class_name() . ' qtype_blocklymoodle_response'));
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_blocklymoodle_format_editorfilepicker_renderer extends qtype_blocklymoodle_format_editor_renderer {
    protected function class_name() {
        return 'qtype_blocklymoodle_editorfilepicker';
    }
...
/**
 * An blocklymoodle format renderer for blocklymoodles where the student should use a plain
 * input box, but with a normal, proportional font.
 *
 * @copyright  2011 The Open University
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_blocklymoodle_format_plain_renderer extends plugin_renderer_base {
    /**
     * @return string the HTML for the textarea.
     */
    protected function textarea($response, $lines, $attributes) {
        $attributes['class'] = $this->class_name() . ' qtype_blocklymoodle_response';
    ...
    protected function class_name() {
        return 'qtype_blocklymoodle_plain';
    }
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_blocklymoodle_format_monospaced_renderer extends qtype_blocklymoodle_format_plain_renderer {
    protected function class_name() {
        return 'qtype_blocklymoodle_monospaced';
    }
}
